		...
		<div className=" bg-image-footer ">
			<div className=" py-2 px-4 flex flex-col mx-auto max-w-screen-xl  gap-6 ">
				<div className=" flex flex-col ">
					<h1 className="text-5xl font-extrabold font-general-sans text-slate-900 lg:hidden">
						LETS MAKE
					</h1>
					<div className="flex flex-row gap-3 lg:hidden">
						<h1 className="text-5xl font-extrabold font-general-sans text-slate-900">YOUR</h1>
					...
					<div className="flex flex-col justify-between lg:hidden ">
						<div className="flex flex-row gap-2">
							<h1 className="text-5xl font-extrabold font-general-sans text-slate-900">TO</h1>
							<h1 className="text-5xl font-extrabold font-general-sans text-lime-400">LIFE</h1>
						</div>
					...
					<div className="hidden lg:block">
						<div className=" flex flex-col ">
							<div className="flex flex-row gap-3 ">
								...
								<h1 className="text-7xl font-extrabold font-general-sans text-slate-900">YOUR</h1>
							</div>
						</div>
						<div className="flex flex-col justify-between  ">
							<div className="flex lg: justify-between ">
								<div className="flex gap-2 flex-row">
									<h1 className="text-7xl font-extrabold font-general-sans text- text-blue-600">
										IDEAS
									</h1>
									<h1 className="text-7xl font-extrabold font-general-sans text-slate-900">TO</h1>
				...
				<div className="flex flex-col justify-center  items-center lg:hidden">
					...
					<p className="text font-bold font-lato ">hello@ideatesolutions.studio</p>
					<p className="text font-bold font-lato text-right"> Davao City, PH 8000</p>
