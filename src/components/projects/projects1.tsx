          ...
          <div className="mt-14 ">
            <div className="flex flex-col  w-full transition duration-1000 ease-in-out group-hover:blur-md ">
              ...
              <div className="flex mx-auto flex-row gap-5 ">
                ...
                <p className="text-8xl text-center font-extrabold font-general-sans text-blue-600 duration-500 ease-in-out transform group-hover:translate-y-[-400%]">
                  AWESOME
                </p>
              </div>

              <h2 className="text-8xl text-center font-extrabold font-general-sans text-white duration-500 ease-in-out transform group-hover:translate-y-[-400%]">
                ON WHAT WE DO.
              </h2>
            </div>
