		...
		<div className="py-10 px-3 bg-home" id="home">
			...
			<div className="flex flex-col mb-24 mx-auto lg:max-w-screen-xl lg:mt-20 lg:mb-72   ">
              ...
              /> */}
							...
							<h1 className="text-7xl font-bold lg:font-extrabold  lg:text-9xl custom-heading font-general-sans   text-white animate-rise delay-1 my-0">
								BUILD
							</h1>
							<h1 className="text-7xl font-bold lg:font-extrabold  lg:text-9xl custom-heading font-general-sans  text-white animate-rise delay-2 mt-0">
								DELIVER
							</h1>
						</div>
